    ...
    <v-menu :close-on-content-click="false">
        ...
        <v-sheet rounded="md" width="360" elevation="10">
                ...
                <div class="d-flex align-center mt-4 pb-6">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="d-flex align-center mt-1">
                            ...
                            <span class="text-subtitle-1 font-weight-regular textSecondary ml-2">{{ $page.props.auth.user.email }}@ufopa.edu.br</span>
                        </div>
                    </div>
                </div>
                <v-divider></v-divider>
            ...
            <div class="pt-4 pb-6 px-8 text-center">
                <v-btn color="primary" variant="outlined" block @click="authStore.logout()">Sair</v-btn>
            </div>
        </v-sheet>
    </v-menu>
</template>
